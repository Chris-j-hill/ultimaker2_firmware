...
// pen modification, build area smaller to accommodate parts attached to print head 
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "UM2 Marlin Config 9"
...
#define X_MAX_POS 230  //subtract the mount offset
#define X_MIN_POS 0
#define Y_MAX_POS 224.5-21  //allow 21mm clearance for the clip on mod 
#define Y_MIN_POS 0
#define Z_MAX_POS 230-7  //subtract distance the pen extends below the nozzle
#define Z_MIN_POS 0
...
#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,40000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
