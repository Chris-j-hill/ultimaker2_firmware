...
#ifdef DISABLE_STEPPER_MENU_OPTION_ENABLE   //if in config file
        else if (IS_SELECTED_SCROLL(12 + BED_MENU_OFFSET + EXTRUDERS * 2))    //disable steppers, run M84 command
//            enquecommand(PSTR("M84"));
 {
            lcd_lib_beep();
//            enquecommand_P(PSTR("G28 X Y"));
            enquecommand_P(PSTR("M84"));        // Release motors
        ...
        else if (IS_SELECTED_SCROLL(11 + added_items + BED_MENU_OFFSET + EXTRUDERS * 2))    //move axis
