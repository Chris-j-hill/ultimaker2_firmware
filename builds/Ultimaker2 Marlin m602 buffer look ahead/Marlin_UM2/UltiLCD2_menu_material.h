...
#define FILAMENT_REVERSAL_LENGTH      (50)  //overshoot bowden retract distance by this to ensure easy removal
...
#define FILAMENT_FORWARD_LENGTH       (-10)   // subrtact from bowden lenght to account for insert distance
