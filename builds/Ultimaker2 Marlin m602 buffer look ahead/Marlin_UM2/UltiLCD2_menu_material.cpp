...
//lcd_change_to_menu_change_material(lcd_change_to_menu_change_material_return);
            ...
            lcd_change_to_menu_change_material(lcd_menu_print_printing);
    }

    lcd_lib_update_screen();
#else
#error "This menu item isnt written yet, disable advanced material change until it is written"
//    currentMenu = lcd_menu_material_main;   
#endif

//currentMenu = lcd_change_to_menu_change_material_return;
