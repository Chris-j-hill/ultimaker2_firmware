...
//6 =  
//7 = 2 bowden extruders, using 1.8 egree stepper motors 
//8 =  
//9 = pen mod
//10 = also pen mod? -> different z offset...
//11 = olsson block bowden and direct drive
//12 = also olsson block bowden and direct drive?  -> files identical
