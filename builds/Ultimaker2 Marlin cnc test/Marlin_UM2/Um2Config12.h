...
// 1 bowden extruder and 1 direct drive extruder, no filament sensor, olsson block upgrade
...
#define CUSTOM_MENDEL_NAME "UM2 Marlin Config 5"
...
//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E, E
